    ...
    return (
        <>
            <section className="flex">
                ...
                <blockquote className="prose bg-gray-200 rounded-lg py-6 px-16 pb-0 mb-24"><p className="text-2xl italic text-gray-600">{phrase[0]?.children?.[0]?.text}</p></blockquote>
            </section>
        </>
    )
}